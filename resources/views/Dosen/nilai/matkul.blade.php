...
<div class="flex items-center justify-between border-b pb-1" id="title">
    <div class="flex items-center gap-4">
        <a href="/dosen" class="text-xl rotate-90 mt-2 text-sky-400 hover:text-sky-200">
            <i class="fa-solid fa-arrow-turn-down"></i>
        </a>
        <h1 class="text-2xl font-semibold">Daftar Nilai Matkul {{ $matkul->nama }}</h1>
    </div>
    <a href="/dosen/nilai/create/{{ $matkul->id }}" class="p-1 px-3 rounded-lg text-white bg-green-500">Tambah Data</a>
</div>
