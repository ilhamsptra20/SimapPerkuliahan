            ...
            <tbody>
                @foreach ($data as $data)
                    <tr class="border-b bg-white hover:bg-slate-100">
                        ...
                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            {!! $data->status === null ? '<p class="text-green-500">Menunggu...</p>' : '<p class="text-red-500">Tidak diterima</p>' !!}
                        </td>
                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            <a href="{{ route('admin.data.show', $data->no_reg ) }}" class="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-blue-600 text-white rounded-full">Detail</a>
                            {{-- <a href="" class="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-red-600 text-white rounded-full">Tolak</a> --}}
                        </td>
